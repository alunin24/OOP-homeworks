...
student2 = Student('Svetlana', 'Sokolova', 'female')
...
lector1 = Lecturer('Sergey', 'Sergeev')
lector2 = Lecturer('Mihail', 'Mihailov')
...
student3 = Student('Roman', 'Tarasov', 'male')
